...
const Checkout = () => {
    ...
    const handlePlaceOrder = event => {
        ...
        // if(phone.length> 10){
        //     alert('Phone number shold be 10 ')
        // }

        fetch('https://genius-car-server-murex-sigma.vercel.app/orders', {
            method: 'POST',
            headers: {
    ...
    return (
        <div>
            ...
            <form onSubmit={handlePlaceOrder}>
                ...
                <textarea name='message' className="textarea textarea-bordered h-24 w-full" placeholder="Your Comment"></textarea>
